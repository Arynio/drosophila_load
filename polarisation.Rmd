...
#Finally, concatenate both files:
...
FILE=/share/rdata/ramon.pouso/POOLS/gen0-40/gen0-40/5variants/multirealigned/crisp_multi_all_masked.recode_snps.final_snp_set.orthologs.confident.aafilled.vcf
...
#Sanity checks:
##No rows were dropped in the gens0-40 polarized file has X rows.
##The gen140 polarized file has 830653 rows instead of 830657 because there were 4 SNPs with AA!=REF & AA!=ALT (a third allele), which were dropped.
