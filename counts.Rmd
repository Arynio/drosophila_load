...
#The -bed flag in CRISP is not working. So I'll launch it for all sites (for each chromosome separately).
...
ggsave(paste0("lines_relativised_pool_counts_variants_4FR_",type,"_Humberto_version.pdf"), width=15, height=12, units="cm", device="pdf", path=wd_path)
...
ggsave("relativised_pool_counts_sites_and_counts_4FR_all_Humberto_version.pdf", width=30, height=23, units="cm", device="pdf", path="/Users/dani/Documents/dani/Post-docs/2022_contrato_Vigo/drosophila_load/Analisis_dani/counts/gen0-140/",ggplot_combined_relativised)
...
ggplot_combined_relativised <- grid.arrange(set_panel_size(Pb_relativised_pool_counts_sites_4FR_ggplot_rec,width=unit(8,"cm"),height=unit(3.5,"cm")),set_panel_size(lines_relativised_pool_counts_sites_4FR_ggplot_rec,width=unit(8,"cm"),height=unit(5,"cm")),set_panel_size(Pb_relativised_pool_counts_copies_4FR_ggplot_rec,width=unit(8,"cm"),height=unit(3.5,"cm")),set_panel_size(lines_relativised_pool_counts_copies_4FR_ggplot_rec,width=unit(8,"cm"),height=unit(5,"cm")), ncol=2)

ggsave("relativised_pool_counts_sites_and_counts_4FR_all_Humberto_version.all_recombination.pdf", width=26, height=28, units="cm", device="pdf", path="/Users/dani/Documents/dani/Post-docs/2022_contrato_Vigo/drosophila_load/Analisis_dani/counts/gen0-140/",ggplot_combined_relativised)
...
SFS_relative_data_Pb_ggplot
ggsave(paste0("Pb_",type,"_proportion_variants_SFS.pdf"), width=39, height=12, units="cm", device="pdf", path=wd_path)
...
SFS_relative_data_lines_ggplot
ggsave(paste0("lines_average_",type,"_proportion_variants_SFS.pdf"), width=29, height=12, units="cm", device="pdf", path=wd_path)
