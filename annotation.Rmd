...
VCF=crisp_all_pools_gen0-140.recode_snps.gen0-140_Pb_0_variable_set.orthologs.confident.polarized.annovar.dm6_multianno.vcf
...
#grep -E '^#|ExonicFunc.refGene=synonymous_SNV;' $VCF | bedtools subtract -a stdin -b /share/rdata/ramon.pouso/counts/synonymous_variants_4fold.bed | awk '{printf ("%s\t%s\t%s\n", $1,$2-1,$2)}' > /share/rdata/ramon.pouso/counts/synonymous_variants_NOT4fold.bed #this line doesn't need to be executed if the bed already exists.
bedtools intersect -a $VCF -b /share/rdata/ramon.pouso/counts/synonymous_variants_NOT4fold.bed | awk '{gsub("NP=44;","CUSTOM=non-fourfold;NP=44;"); print}' >> ${VCF/vcf/custom_unsorted.vcf}
#Fourfold:
bedtools intersect -a $VCF -b /share/rdata/ramon.pouso/counts/synonymous_variants_4fold.bed | awk '{gsub("NP=44;","CUSTOM=fourfold;NP=44;"); print}' >> ${VCF/vcf/custom_unsorted.vcf}
#Tolerated:
bedtools intersect -a $VCF -b /share/rdata/ramon.pouso/counts/missense_variants_provean_SIFT_tolerated.bed | awk '{gsub("NP=44;","CUSTOM=tolerated;NP=44;"); print}' >> ${VCF/vcf/custom_unsorted.vcf}
#Deleterious:
bedtools intersect -a $VCF -b /share/rdata/ramon.pouso/counts/missense_variants_provean_SIFT_deleterious.bed | awk '{gsub("NP=44;","CUSTOM=deleterious;NP=44;"); print}' >> ${VCF/vcf/custom_unsorted.vcf}
#LoF:
