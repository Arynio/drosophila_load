...
!!!GENERATE NEW DB FOR THE ANCESTRAL GENOME USING:
...
#I encountered this bug: https://github.com/rvaser/sift4g/issues/10 and edited the code as suggested here. However I kept running into the same problem until I realised that the programme doesn't remove the all_prot.fasta file, so it keeps appending the wrong sequences.

#If it crashes again, download https://github.com/pauline-ng/SIFT4G_Create_Genomic_DB/files/3877234/make-SIFT-db-starting_from_SIFT4G.pl.txt and continue from there.
...
cd /mnt/lustre/scratch/home/uvi/bg/dkr/provean_annotation
JOB_ID=7948007 #Introduce the finished job id.
...
sbatch --array=1-$PARALLEL /mnt/lustre/scratch/home/uvi/bg/dkr/provean_annotation/parallel_provean_remaining.sh gene_list.chunk_1_to_chunk_10.remaining.txt
...
#4. Carry out recombination annotation.
