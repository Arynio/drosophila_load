...
mkdir -p /mnt/lustre/scratch/nlsas/home/uvi/bg/dkr/sift4g_annotation/annotation/two_parsimony_pools_gen0-6/
...
#From the local environment:ll -rth coun
...
average_relativised_pool_counts_copies_4FR_ggplot
ggsave(paste0("rarefied_depth_",depth,"_pool_avg_relativised_counts_copies_4FR_",type,".sitesinline",line,".pdf.bis"), width=15, height=12, units="cm", device="pdf", path=wd_path)
...
average_relativised_pool_counts_copies_4FR_ggplot
ggsave(paste0("rarefied_depth_",depth,"_pool_sep_relativised_counts_copies_4FR_",type,".sitesinline",line,".pdf.bis"), width=15, height=12, units="cm", device="pdf", path=wd_path)
}
