...
for POP in ${POP_LIST[@]}
  ...
  FILTER_X=$(echo $AVG_X + 3*$FILTER_X | bc)
...
#10. Import all annotations into the VCF.
```{bash}
...
#Tolerated:
bedtools intersect -a $VCF -b gen0-140_all_sites_missense_variants_SIFT_scores_020tolerated.bed | awk '{gsub("NP=44;","CUSTOM=tolerated;NP=44;"); print}' >> ${VCF/vcf/custom_unsorted.vcf}
#Deleterious:
bedtools intersect -a $VCF -b gen0-140_all_sites_missense_variants_SIFT_scores_deleterious.bed | awk '{gsub("NP=44;","CUSTOM=deleterious;NP=44;"); print}' >> ${VCF/vcf/custom_unsorted.vcf}
#LoF:
...
#11. Split the VCFs at the pool level:
...
ggsave(paste0("Pb_lines_relativised_pool_counts_copies_4FR_",type,"tol020.pdf"), width=15, height=12, units="cm", device="pdf", path=wd_path)

```

#14. Perform the bootstrap:
